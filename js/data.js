...
const LINES = {
  tohoku: {
    name: '東北新幹線', op: 'jre', color: '#6f8f6b', mins: 185, km: 714,
    stations: ['東京','上野','大宮','小山','宇都宮','那須塩原','新白河','郡山','福島','白石蔵王','仙台','古川','くりこま高原','一ノ関','水沢江刺','北上','新花巻','盛岡','いわて沼宮内','二戸','八戸','七戸十和田','新青森'],
  },
  hokkaido: {
    name: '北海道新幹線', op: 'jrh', color: '#93a06a', mins: 60, km: 149,
    stations: ['新青森','奥津軽いまべつ','木古内','新函館北斗'],
  },
  akita: {
    name: '秋田新幹線', op: 'jre', color: '#b07f8c', mins: 100, km: 127,
    stations: ['盛岡','雫石','田沢湖','角館','大曲','秋田'],
  },
  yamagata: {
    name: '山形新幹線', op: 'jre', color: '#c39a63', mins: 100, km: 149,
    stations: ['福島','米沢','高畠','赤湯','かみのやま温泉','山形','天童','さくらんぼ東根','村山','大石田','新庄'],
  },
  joetsu: {
    name: '上越新幹線', op: 'jre', color: '#bd7a63', mins: 105, km: 334,
    stations: ['東京','上野','大宮','熊谷','本庄早稲田','高崎','上毛高原','越後湯沢','浦佐','長岡','燕三条','新潟'],
  },
  hokuriku: {
    name: '北陸新幹線', op: 'jre', color: '#5f8f8a', mins: 200, km: 580,
  ...
  tokaido: {
    name: '東海道新幹線', op: 'jrc', color: '#6d87a6', mins: 150, km: 553,
    stations: ['東京','品川','新横浜','小田原','熱海','三島','新富士','静岡','掛川','浜松','豊橋','三河安城','名古屋','岐阜羽島','米原','京都','新大阪'],
  },
  sanyo: {
    name: '山陽新幹線', op: 'jrw', color: '#6b7392', mins: 150, km: 623,
    stations: ['新大阪','新神戸','西明石','姫路','相生','岡山','新倉敷','福山','新尾道','三原','東広島','広島','新岩国','徳山','新山口','厚狭','新下関','小倉','博多'],
  },
  kyushu: {
    name: '九州新幹線', op: 'jrk', color: '#a9765f', mins: 90, km: 289,
    stations: ['博多','新鳥栖','久留米','筑後船小屋','新大牟田','新玉名','熊本','新八代','新水俣','出水','川内','鹿児島中央'],
  },
  nishikyushu: {
    name: '西九州新幹線', op: 'jrk', official: 'jrk_nishi', color: '#8c7086', mins: 30, km: 66,
