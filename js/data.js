...
const TRANSFERS = [
  { a: '武雄温泉', lineA: 'nishikyushu', b: '博多', lineB: 'sanyo',  note: '在来線特急「リレーかもめ」（武雄温泉〜博多、約1時間20分）' },
  { a: '武雄温泉', lineA: 'nishikyushu', b: '博多', lineB: 'kyushu',  note: '在来線特急「リレーかもめ」（武雄温泉〜博多、約1時間20分）' },
];
